...
function murray_customize_register_fonts($wp_customize){
    ...
    function murray_sanitize_gfont( $input ) {
        if ( in_array($input, array('Fjalla One','Source Sans Pro','Khula','Open Sans','Droid Sans','Droid Serif','Roboto','Roboto Condensed','Lato','Bree Serif','Oswald','Slabo','Lora','PT Sans','Ubuntu','Lobster','Arimo','Bitter','Noto Sans') ) )
        return $input;
        else
        return '';
    }
